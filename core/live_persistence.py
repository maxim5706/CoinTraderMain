...
class LivePositionPersistence(IPositionPersistence):
    """Stores live positions separately from paper mode."""

    def __init__(self, path: Path | None = None):
        self.positions_file = path or Path("data/live_positions.json")
